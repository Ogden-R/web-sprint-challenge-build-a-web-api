...
1. The core features of Node.js and Express and why they are useful.
  - these tools are useful because they help use clean and simplify our code with the custom middleware they provide us access to. they also help us respond to http requests and define specific routes.
2. Understand and explain the use of Middleware.
  - middleware essentially helps the operating system and the applications to communicate more easily. 
3. The basic principles of the REST architectural style.
  - everything is a resource that is accessible using a unique URL. resources can have multiple representations, communication happens over a stateless protocol like http, and recource management happens through HTTP methods.
4. Understand and explain the use of Express Routers.
  -  they are a way of organizing express applications. 
